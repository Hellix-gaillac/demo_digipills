...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 19 juin 2019 à 10:52
...
CREATE TABLE IF NOT EXISTS `medicament` (
  ...
  `forme_pharmaceutique` varchar(50) CHARACTER SET utf8 NOT NULL,
  `voie_administration` varchar(50) CHARACTER SET utf8 NOT NULL,
  `indication_therapeutique` mediumtext CHARACTER SET utf8,
  `substance_active` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `dosage_substance` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `medicament` (`id_medicament`, `code_cis`, `denomination`, `forme_pharmaceutique`, `voie_administration`, `indication_therapeutique`, `substance_active`, `dosage_substance`) VALUES
